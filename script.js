...
const TRANSLATIONS = {
  en: {
    ...
    navHonors: 'Honors',
    navContact: 'Contact',
    heroBadge: 'RF intelligence · Edge AI · Language models',
    ...
    heroLede: 'I’m a Ph.D. candidate at UESTC working on RF intelligence and efficient AI at the edge. My recent work includes RFLM, an RF language model accepted by IEEE TMC.',
    ...
    aboutLead: 'I am a Ph.D. candidate in Information and Communication Engineering at UESTC.',
    aboutBody: 'I study how RF models can stay reliable across changing environments and run efficiently on resource-constrained hardware. My work spans RF fingerprinting, domain adaptation, efficient inference, and RF language models.',
    ...
    researchIntro: 'My research connects RF representation learning, cross-scene adaptation, edge deployment, and language models.',
    rfTitle: 'RF Signal Intelligence',
    rfBody: 'Learning useful representations from RF signals and identifying wireless devices reliably.',
    adaptTitle: 'Cross-domain Adaptation',
    adaptBody: 'Adapting RF models across receivers, channels, locations, and time without requiring labels everywhere.',
    edgeTitle: 'Efficient Edge Deployment',
    edgeBody: 'Making inference practical on FPGAs, GPUs, and other resource-constrained edge hardware.',
    agentTitle: 'Edge LLMs, MLLMs & Agents',
    agentBody: 'RFLM is one step in this direction; edge MLLMs and wireless cognitive agents are ongoing work.',
    ...
    contactIntro: 'If our work overlaps, feel free to get in touch.',
    footerLine: 'RF intelligence, edge AI, and language models for wireless signals.',
    ...
    pageDescription: 'Zhongyi Wen is a Ph.D. candidate at UESTC working on RF intelligence, efficient edge AI, and language models for wireless signals.'
  },
  zh: {
    skipLink: '跳到主要内容',
    ...
    navHonors: '荣誉',
    navContact: '联系',
    heroBadge: '射频智能 · 边缘人工智能 · 语言模型',
    heroKicker: '你好，我是文钟毅 👋',
    heroAcademicRole: '电子科技大学博士生',
    heroCompanyRole: '瀚铄智擎科技有限公司创始人兼 CEO',
    heroLede: '我目前在电子科技大学攻读信息与通信工程博士学位，主要研究射频智能与边缘人工智能。近期工作包括已被 IEEE TMC 接收的射频语言模型 RFLM。',
    topicRf: '射频智能',
    topicLlm: '端侧大语言模型',
    topicMllm: '多模态大模型',
    topicAgents: '无线认知智能体',
    ...
    aboutEyebrow: '关于我',
    aboutTitle: '关于我',
    aboutLead: '我目前在电子科技大学攻读信息与通信工程博士学位，主要研究射频智能与边缘人工智能。',
    aboutBody: '我关心两个问题：模型能否在不断变化的无线环境中保持可靠，以及它能否真正运行在资源有限的边缘设备上。围绕这些问题，我开展射频指纹识别、跨域适应、高效推理和射频语言模型研究。',
    founderLabel: '创业',
    ...
    researchIntro: '我的工作主要围绕射频信号表示、跨场景适应、边缘部署和语言模型展开。',
    rfTitle: '射频信号智能',
    rfBody: '从射频信号中学习有效表征，并更可靠地识别无线设备。',
    adaptTitle: '跨域场景适应',
    adaptBody: '让射频模型在接收机、信道、地点和时间发生变化时仍能稳定工作。',
    edgeTitle: '边缘高效部署',
    edgeBody: '研究动态推理、早退机制、FPGA 预处理和 GPU 加速，让模型真正运行在边缘设备上。',
    agentTitle: '边缘 LLM、MLLM 与智能体',
    agentBody: 'RFLM 是我在射频语言模型方向上的一项工作；端侧 MLLM 与无线认知智能体是正在继续探索的方向。',
    arcLabel: '研究演进',
    arcTitle: '这些工作如何联系起来',
    arcInput: '多源射频输入',
    arcTrust: '可信设备识别',
    ...
    contactIntro: '欢迎就射频智能、边缘人工智能或相关技术合作与我联系。',
    footerLine: '射频智能、边缘人工智能与无线信号语言模型。',
    footerBuilt: '个人学术主页',
    firstAuthor: '第一作者',
    ...
    pageDescription: '文钟毅，电子科技大学博士生、瀚铄智擎科技有限公司创始人兼 CEO，主要研究射频智能、边缘人工智能与射频语言模型。'
  }
};
